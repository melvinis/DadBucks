    ...
    it('approves tokens for delegated transfer', function() {
      ...
      it('handles delegated token transfers', function() {
        return DadBucks.deployed().then(function(instance) {
          ...
          assert.equal(balance.toNumber(), 90, 'debits the amount from the sending account');
          
          return tokenInstance.balanceOf(toAccount);
        }).then(function(balance) {
          assert.equal(balance.toNumber(), 10, 'credits the amount from the receiving account');
